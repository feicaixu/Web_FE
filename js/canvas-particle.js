var CanvasParticle = (function(){
	...
	function canvasInit(canvasConfig){
		...
		var canvas = {
			...
			// 默认配置
			config: {
				vx: canvasConfig.vx || 4,//点x轴速度,正为右，负为左
				vy:  canvasConfig.vy || 4,//点y轴速度
				height: canvasConfig.height || 2,//点高宽，其实为正方形，所以不宜太大
				width: canvasConfig.width || 2,
				count: canvasConfig.count || 100,//点个数
				color: canvasConfig.color || "121, 162, 185",//RGB点颜色
				stroke: canvasConfig.stroke || "130,255,255",//RGB线条颜色
		...
		body.style.padding = "0";//设置body内外边距，与画布全部契合
		body.style.margin = "0";
